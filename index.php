    ...
    <div class="row">
        ...
        <div class="col-12 main">
            <div class="carousel mb-4 w-auto">
                <div class="slides">
                    <img src="assets/banners/serenity_banner.jpg" alt="slide image" class="slide">
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="lh-1 fs-1 p-4 m-2 main">
                ...
                <div class="row">
                    <div class="col">
                        <h3>Top Products</h3>
                        <p class="text-muted h6">We've sorted through our feed to put together a collection of our products perfect for your body.</p>
                    </div>
